...
//using namespace std;
//
////This function takes a number of rows as a first parameter and a number of columns as its second parameter. It then returns
////a pointer to a pointer to an int that holds a two-dimensional array of integers.
//int** fillArray(unsigned int, unsigned int);
//
//
////This function takes a dynamically allocated 2D array and sends it to the bit bucket in the sky, er, I mean deletes it. 
////The first parameter will be the two dimensional array, viewed as a pointer to a pointer to an int. The second parameter is the number of rows in that array.
